...
import { AVAILABILITY_MONTHS, UNIT_ID, availabilityWindow } from "@/lib/availability";
...
export async function fetchGoogleAvailability(unitId = UNIT_ID): Promise<AvailabilityPayload> {
  ...
  if (!body.includes("BEGIN:VCALENDAR")) {
    throw new Error(
      "CALENDAR_ICS_URL did not return an iCal calendar. Use the secret iCal address from Google Calendar.",
    );
  }
